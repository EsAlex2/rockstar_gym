...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 min-h-screen flex flex-col justify-center items-center transition-colors duration-300 relative px-4">
    ...
    <div class="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-8 shadow-xl">
        ...
        <form action="authlogin.php" method="POST" class="space-y-4">
            <div>
                <label class="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Correo / Usuario / Cédula</label>
                <input type="text" name="identity" required autocomplete="username" placeholder="Ej: alexmadrid326@gmail.com o root" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-hidden focus:border-orange-500 text-sm transition-colors">
            </div>
