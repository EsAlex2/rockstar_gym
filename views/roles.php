                                ...
                                <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-900/10 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <button 
                                            ...
                                            class="px-3 py-1.5 text-xs font-semibold text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-950/30 rounded-lg transition-all cursor-pointer inline-flex items-center gap-1">
